...
/*   Updated: 2026/03/17 16:56:06 by relaforg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	handle_burnout(t_env *ctx, int i, long long t)
{
	...
	printf("%lld %d burned out\n",
		t - ctx->config.start_time, ctx->coders[i].id);
